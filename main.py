...
def resolve_data_dir(relative_path: str, fallback_path: str, required_file: str) -> Path:
    ...
    candidates = [
        Path("C:/Users/hp/Downloads/Amazon_ML_Challenge/student_resource") / relative_path,
        Path(fallback_path),
        Path(relative_path),
    ]
    for c in candidates:
...
def main():
    ...
    train_dir = resolve_data_dir("dataset/train", "C:/Users/hp/Downloads/Amazon_ML_Challenge/student_resource/dataset/train", "train_ground_truth.tsv")
    test_dir = resolve_data_dir("dataset/test", "C:/Users/hp/Downloads/Amazon_ML_Challenge/student_resource/dataset/test", "test_source1.tsv")
